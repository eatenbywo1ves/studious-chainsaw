...
def demo_complexity_hierarchy():
    ...
    for op in operations:
        ...
        print(
            f"  {symbol}  {op:<25} {complexity.time_complexity:<12} "
...
def demo_transformation_complexity():
    ...
    chain_1 = analyzer.track_transformation_complexity(score_original, "DeviceRouting", score_1)
    ...
    chain_2 = analyzer.track_transformation_complexity(
        score_original, "BatchFusion", score_2, chain_1
    )
    ...
    chain_3 = analyzer.track_transformation_complexity(
        score_original, "KernelFusion", score_3, chain_2
    )
        ...
        if bottlenecks:
            ...
            for i, bottleneck in enumerate(bottlenecks, 1):
                ...
                suggestions = hierarchy_mgr.suggest_complexity_reductions(
                    bottleneck["operation"], mock_score
                )
