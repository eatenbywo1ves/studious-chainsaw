...
try:
    ...
    requirements = BackendRequirements(
        preferred_backend=GPUBackend.CPU, min_memory_mb=100, allow_cpu_fallback=True
    )
...
try:
    ...
    lattice = GPUFactoryRefactored.create(dimensions=3, size=4, backend=GPUBackend.CPU)
