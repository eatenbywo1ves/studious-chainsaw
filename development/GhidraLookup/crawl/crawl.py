...
def fetch_function(site, f_name):
    ...
    try:
        ...
        while i and i.find("code"):  # found new parameter name
            param_data = {"name": "", "type": "", "description": "", "possible_constants": []}
            p_name = i.text.strip()
            ...
            if (
                i and i.name == "p" and i.text.startswith("Type:")
            ):  # sometimes the 2nd paragraph is the type
            ...
            while i and (i.name == "p" or i.name == "table") and not i.find("code"):
                if i.name == "p":  # append description
                    p_desc += "\n" + i.text.strip()
                elif i.name == "table" and i.tr.th.text.startswith(
                    "Value"
                ):  # append possible constants
