...
class VonNeumannObservatoryAdapter:
    def __init__(self, agent_instance, server_url="ws://localhost:8080/ws", agent_name="VonNeumannAgent"):
    ...
    async def collect_and_send_metrics(self):
        ...
        metrics = {
            ...
            "metrics": [
                ...
                {"name": "tasks_completed", "value": self.task_counter, "unit": "count"},
                {"name": "synthesis_events", "value": self.synthesis_events, "unit": "count"},
    ...
    def on_task_start(self, task_name: str, data: Dict = None):
        ...
        asyncio.create_task(self.send_event(
            "task_start", "info", f"Started task: {task_name}", data
        ))
    ...
    def on_task_complete(self, task_name: str, duration_ms: float, data: Dict = None):
        ...
        asyncio.create_task(self.send_event(
            "task_complete", "info", 
            f"Completed task: {task_name} in {duration_ms:.2f}ms", data
        ))
...
class ObservatoryEnabledVonNeumannAgent:
    ...
    def reason_about(self, *args, **kwargs):
        ...
        try:
            ...
            self.adapter.on_task_complete(task_name, duration, {"result_type": type(result).__name__})
            return result
        except Exception as e:
    ...
    def synthesize_knowledge(self, *args, **kwargs):
        ...
        try:
            ...
            self.adapter.on_synthesis_event("mathematics", "computer_science", "New computational insight")
            return result
        except Exception as e:
