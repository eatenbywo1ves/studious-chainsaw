...
class ValidationTestAgent:
        ...
        for case in test_cases:
            try:
                ...
                self.test_results[f"registration_{case['name']}"] = {
                    "passed": case["should_pass"] == False,
                    "error": str(e)
                }
                if case["should_pass"]:
                    self.validation_errors.append(f"Registration test '{case['name']}' failed: {e}")
    ...
    async def test_metrics_validation(self):
        ...
        test_cases = [
            ...
            # Invalid metric value type
            {
                ...
                "data": {
                    ...
                    "agentName": self.agent_name,
                    "metrics": [
                        {"name": "test_metric", "value": "not_a_number", "unit": "count"}
                    ],
                    "timestamp": datetime.now().isoformat() + "Z"
                },
                "should_pass": False
            ...
            # Missing metric fields
            {
                ...
                "data": {
                    ...
                    "agentName": self.agent_name, 
                    "metrics": [
                        {"name": "test_metric"}  # Missing value and unit
                    ],
                    "timestamp": datetime.now().isoformat() + "Z"
                },
                "should_pass": False
        ...
        for case in test_cases:
            try:
                ...
                if case["should_pass"]:
                    self.validation_errors.append(f"Metrics test '{case['name']}' failed: {e}")
    ...
    async def test_event_validation(self):
        ...
        for case in test_cases:
            try:
                ...
                if case["should_pass"]:
                    self.validation_errors.append(f"Event test '{case['name']}' failed: {e}")
    ...
    async def test_malformed_data(self):
        ...
        for case in test_cases:
            try:
                ...
                if case["should_pass"]:
                    self.validation_errors.append(f"Malformed test '{case['name']}' failed: {e}")
    ...
    async def test_edge_cases(self):
        ...
        try:
            ...
            self.test_results["edge_rapid_messages"] = {"passed": False, "error": str(e)}
